    ...
    return (
        <>
            ...
            <div>
                ...
                <div className=''>
                    <h3 className='text-2xl text-center text-transparent bg-clip-text bg-gradient-to-br from-accent to-secondary mt-3'>Sabbir Ahammed</h3>
                    <div className='flex flex-col justify-center items-center mb-6'>
                        <h3 className='text-lg text-sky-500'>sabbir.ah799@gmail.com</h3>
                        <Link to='https://www.linkedin.com/in/sabbir-ah/' className="text-lg btn-active btn-info btn-link">Linkedin profile</Link >
                        <Link to='https://github.com/sabbirpboss' className="text-lg btn-active btn-info btn-link">Portfolio</Link >
                    </div>

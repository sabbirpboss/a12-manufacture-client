        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                ...
                <div className="modal-box">
                    ...
                    <h3 className='text-2xl text-center font-bold my-8'><span className=' border-b-2 border-accent'>Order for: {productName}</span></h3>
                    ...
                    <form
                        ...
                        <input type="submit" value="Confirm Order ✔" className="btn btn-accent w-full max-w-xs" />
                    </form>

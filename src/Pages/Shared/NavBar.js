        ...
        <div className="drawer drawer-end">
            ...
            <div className="drawer-content flex flex-col">
                <div className="w-full navbar top-0 z-10">
                    {pathname.includes('dashboard') && <label htmlFor="dashboard-sidebar" className="btn btn-square btn-ghost lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </label>}
                    <div className="flex-1 px-2 mx-2"><Link to='/' ><img className='w-48' src={logo} alt="industo" /></Link></div>
                    ...
                    <div className="flex-none hidden lg:block">
                        <ul className="menu menu-horizontal text-black text-base">

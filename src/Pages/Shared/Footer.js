...
const Footer = () => {
    return (
        <footer className='pt-20 bg-gray-400'>
            <footer className="footer p-10 bg-gray-400 text-base-content font-bold">
                <div>
            ...
            <footer className="footer items-center p-4 bg-gray-500 text-neutral-content">
                <div className="items-center grid-flow-col">
                    <img className='h-16' src={logo} alt="" />
                    <p>Digitaz Industries Ltd.Providing reliable tech since 1992</p>
                </div>
